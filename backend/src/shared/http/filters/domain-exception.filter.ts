...
@Catch(AuthenticationError, ResourceConflictError, ResourceNotFoundError, ValidationDomainError)
export class DomainExceptionFilter implements ExceptionFilter {
  ...
  private reply(
    response: { status?: (code: number) => { json?: (body: unknown) => void; send?: (body: unknown) => void } } & {
