...
import { ACCOUNT_REPOSITORY, TRANSACTION_REPOSITORY } from '../../shared/constants/injection-tokens';
...
@Module({
  imports: [TypeOrmModule.forFeature([AccountEntity, TransactionEntity]), UsersModule],
